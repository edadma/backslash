...
[![Version](https://img.shields.io/badge/latest_release-v0.4.23-orange.svg)](https://github.com/edadma/backslash/releases/tag/v0.4.23)
...
An executable can be downloaded from [here](https://dl.bintray.com/edadma/generic/backslash-0.4.23.jar). *You do not need* the Scala library for it to work because the JAR already contains all dependencies. You just need Java 11+ installed.
